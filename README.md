...
- [submitted]Zoo3D: Zero-Shot 3D Object Detection at Scene Level[[paper](https://arxiv.org/pdf/2511.20253)]
...
- [submmited]Open Vocabulary Monocular 3D Object Detection[[paper](https://arxiv.org/pdf/2411.16833)]
### 2025
**TPAMI 2025 (Accepted Papers)**
- [submmited]Collaborative Novel Object Discovery and Box-Guided Cross-Modal Alignment for Open-Vocabulary 3D Object Detection[[paper](https://arxiv.org/pdf/2406.00830)]
**ICCV 2025 (Accepted Papers)**
- [submmited]3D-MOOD: Lifting 2D to 3D for Monocular Open-Set Object Detection[[paper](https://arxiv.org/pdf/2507.23567)]  
- [submmited]OpenM3D: Open Vocabulary Multi-view Indoor 3D Object Detection without Human Annotations[[paper](https://arxiv.org/pdf/2508.20063)]
**BMVC 2025 (Accepted Papers)**
- [submmited]OVODA:Towards Open-Vocabulary Multimodal 3D Object Detection with Attributes[[paper](https://arxiv.org/pdf/2508.16812)]
**AAAI 2025 (Accepted Papers)**
- [submmited]HCMA：Hierarchical Cross-Modal Alignment for Open-Vocabulary 3D Object Detection[[paper](https://arxiv.org/pdf/2503.07593)]
**NeurIPS 2025 (Accepted Papers)**
- [submiited]OpenBox: Annotate Any Bounding Boxes in 3D[[paper](https://arxiv.org/pdf/2512.01352)]
**arxiv**
